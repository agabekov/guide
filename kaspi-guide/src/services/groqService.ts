...
Твоя задача - написать ответ на вопрос клиента, используя информацию из исходного текста.
...
2. Ответ должен быть написан в том же стиле, тоне и формате, как уже существующие ответы из примеров выше
